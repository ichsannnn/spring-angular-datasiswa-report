...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                .authorizeRequests()
                    .antMatchers(HttpMethod.GET, "/siswa/**").hasRole("PESERTA_VIEW")
                    .antMatchers(HttpMethod.POST, "/siswa/**").hasRole("PESERTA_CREATE")
                    .antMatchers(HttpMethod.DELETE, "/siswa/**").hasRole("PESERTA_DELETE")
                    .antMatchers(HttpMethod.PUT, "/siswa/**").hasRole("PESERTA_UPDATE")
                    .antMatchers(HttpMethod.GET, "/siswa/**").hasRole("USER_VIEW")
